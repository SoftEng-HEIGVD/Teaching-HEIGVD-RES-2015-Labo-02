...
public class RouletteV2MoufbluTest
{
    ...
    @Test
    @TestAuthor(githubId = {"Moufblu", "jimmyVerdasca"})
    public void theServerShouldGiveAnEmptyList() throws IOException, EmptyStoreException {
        IRouletteV2Client client = (IRouletteV2Client) roulettePair.getClient();
        assertEquals(0, client.getNumberOfStudents());
    ...
    @Test
    @TestAuthor(githubId = {"Moufblu", "jimmyVerdasca"})
    public void theServerShouldGiveAListContainingSutdents() throws IOException, EmptyStoreException {
        IRouletteV2Client client = (IRouletteV2Client) roulettePair.getClient();
