...
public class QuizRouletteServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RouletteServer server1 = new RouletteServer(RouletteV1Protocol.DEFAULT_PORT, RouletteV1Protocol.VERSION);
        RouletteServer server2 = new RouletteServer(RouletteV2Protocol.DEFAULT_PORT, RouletteV2Protocol.VERSION);
        try {
            server1.startServer();
            server2.startServer();
