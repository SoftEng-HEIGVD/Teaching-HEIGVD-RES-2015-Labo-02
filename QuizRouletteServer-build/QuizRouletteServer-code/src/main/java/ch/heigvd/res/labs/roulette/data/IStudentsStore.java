...
public interface IStudentsStore {
    ...
    /**
     * This method is used to get the list of students currently in the data
     * store
     *
     ...
     * BufferedReader passed in argument. Data is read line by line and the
     * whole line is used as the student full name.
     *
