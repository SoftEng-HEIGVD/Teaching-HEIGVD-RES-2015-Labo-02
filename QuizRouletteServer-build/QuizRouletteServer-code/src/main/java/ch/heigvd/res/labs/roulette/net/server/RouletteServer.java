...
public class RouletteServer {
    ...
    final private String protocolVersion;

    /**
     * Constructor used to create a server that will accept connections on a
     * known TCP port
     *
    ...
    /**
     * Indicates whether the server is accepting connection requests, by
     * checking the state of the server socket
     *
     ...
     * interaction with the server (e.g. the user has issued the BYE command,
     * the connection has been closed, etc.)
     *
