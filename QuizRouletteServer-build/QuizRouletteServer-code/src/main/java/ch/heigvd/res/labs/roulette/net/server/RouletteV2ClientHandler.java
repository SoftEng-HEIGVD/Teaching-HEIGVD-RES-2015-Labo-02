    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_LOAD:
          ...
          LoadCommandResponse load = new LoadCommandResponse(SUCCESS_STATUS, store.getNumberOfStudents());
        ...
        case RouletteV2Protocol.CMD_LIST:
          ListCommandResponse students = new ListCommandResponse(store.listStudents());
        ...
        case RouletteV2Protocol.CMD_CLEAR:
          ...
          break;
        default:
          /* We only count number of commands that are corrects */
          --nbCommandsSession;
