    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_LOAD:          
          ...
          LoadCommandResponse lcResponse = new LoadCommandResponse(RouletteV2Protocol.SUCCESS, store.getNumberOfStudents());
          writer.println(JsonObjectMapper.toJson(lcResponse)); 
          writer.flush();
          break;
        case RouletteV2Protocol.CMD_BYE:
          ByeCommandResponse bcResponse = new ByeCommandResponse(RouletteV2Protocol.SUCCESS, numberOfCommands);
        ...
        case RouletteV2Protocol.CMD_LIST:      
          ListCommandResponse listCommandResponse = new ListCommandResponse(store.listStudents());
