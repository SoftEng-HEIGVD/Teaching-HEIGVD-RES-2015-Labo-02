        ...
        while (!done && ((command = reader.readLine()) != null)) {
            ...
            switch (command.toUpperCase()) {
                ...
                case RouletteV2Protocol.CMD_LOAD:
                    ...
                    String statusLoad = "success";
                    try {
                        store.importData(reader);
                    } catch (IOException e) {
                        statusLoad = "failure";
                    }
                    int numberOfNewStudents = store.getNumberOfStudents() - nbStudentsBefore;
                    LoadCommandResponse loadCommandResponse = new LoadCommandResponse(statusLoad, numberOfNewStudents);
