        ...
        while (!done && ((command = reader.readLine()) != null)) {
            ...
            switch (command.toUpperCase()) {
                ...
                case RouletteV2Protocol.CMD_LOAD:
                    int nbStudentsBeforeInsertion = store.getNumberOfStudents();
                    writer.println(RouletteV2Protocol.RESPONSE_LOAD_START);
                    writer.flush();
                    
                    store.importData(reader);
                    
                    LoadCommandResponse  loadResponse = new LoadCommandResponse("success", store.getNumberOfStudents() - nbStudentsBeforeInsertion);
