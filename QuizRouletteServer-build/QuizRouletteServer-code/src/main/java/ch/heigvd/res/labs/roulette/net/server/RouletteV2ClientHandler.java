    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV1Protocol.CMD_LOAD:
          LoadCommandResponse load = new LoadCommandResponse(RouletteV2Protocol.VERSION, store.getNumberOfStudents());
          writer.println(JsonObjectMapper.toJson(load));
          writer.flush();
          break;
        case RouletteV2Protocol.CMD_BYE:
          ByeCommandResponse bye = new ByeCommandResponse(RouletteV2Protocol.VERSION, RouletteV2Protocol.SUPPORTED_COMMANDS.length);
