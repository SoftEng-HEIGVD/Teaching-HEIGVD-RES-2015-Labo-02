    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_LOAD:
          ...
          // Serialize data on the fly...
          writer.println(JsonObjectMapper.toJson(new Object() {
              public String status = "success";
              public int numberOfStudents = store.getNumberOfStudents();
          }));
        ...
        case RouletteV2Protocol.CMD_BYE:
          ...
          // Send goodbye json stats
          writer.println(JsonObjectMapper.toJson(new Object() {
              public String status = "success";
              public int numberOfCommands = nbCommands;
          }));
          writer.flush();
          done = true;
